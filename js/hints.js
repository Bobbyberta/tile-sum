...
export function provideHint(day, context = {}) {
    ...
    const tilesContainerId = isArchive ? 'archive-tiles-container' : 'tiles-container';
    ...
    if (hintsToPlace.length === 0) {
        const feedbackId = isArchive ? 'archive-feedback' : 'feedback';
    ...
    if (isArchive) {
        ...
        decrementHintsRemaining();
        updateHintButtonText('hint-btn', getHintsRemaining());
    }
